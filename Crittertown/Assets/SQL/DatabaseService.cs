...
public class DataService : SVBLM.Core.Singleton<DataService>  {
	...
	public IEnumerator CreateDB(){
		yield return _connection.DropTable<Placeable> ();
		yield return _connection.CreateTable<Placeable> ();
	}
	
	public static IEnumerable<Placeable> GetPlaceables(){
		return Instance._connection.Table<Placeable>();
	}
